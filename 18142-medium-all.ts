...
type cases = [
  ...
  Expect<Equal<All<[], 2>, false>>
];

// ============= Your Code Here =============
type All<T extends any[], U> = T extends [] ? false : SubAll<T, U>;

type SubAll<T extends any[], U> = T extends [infer H, ...infer R]
  ? Equal<H, U> extends false
    ? false
    : SubAll<R, U>
  : true;
